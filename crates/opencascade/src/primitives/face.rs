...
impl Face {
    ...
    pub fn surface_type(&self) -> SurfaceType {
        ...
        match surface_type {
            ...
            ffi::GeomAbs_SurfaceType::GeomAbs_SurfaceOfExtrusion => {
                let direction = ffi::BRepAdaptor_Surface_Direction(&surface);
...
pub enum SurfaceType {
    ...
    /// A surface of linear extrusion (generated by extruding a curve along a direction).
    Extrusion {
